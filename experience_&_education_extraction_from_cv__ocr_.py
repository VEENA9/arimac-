...
!git config --global user.email "aevaev39@gmail.com"
!git config --global user.name "VEENA9"

!git init
!git add README.md
!git commit -m "finished"
!git branch -M main
!git remote add origin https://github.com/VEENA9/Extracting-Details-from-cv.git
...
! git clone https://github.com/VEENA9/Extracting-Details-from-cv.git
...
!git remote add origin https://$username:$password@github.com/$username/Extracting-Details-from-cv.git
